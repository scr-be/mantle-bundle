...
use Scribe\MantleBundle\Tests\Doctrine\Fixtures\BaseEntity;
use Scribe\MantleBundle\Tests\Doctrine\Fixtures\BaseEntityHasPerson;
...
class EntityModelTest extends WonkaTestCase
{
    ...
    {
        $entityName = 'Scribe\MantleBundle\Tests\Doctrine\Fixtures\BaseEntity'.$traitName;
    ...
    public function testEntityIsCastable()
    {
        ...
        static::assertEquals('Scribe\MantleBundle\Tests\Doctrine\Fixtures\BaseEntity', (string) $entity);
