...
namespace Scribe\MantleBundle\Tests\Component\HttpFoundation\Response;
...
class RequestTest extends KernelTestCase
{
    public function testRequestFactoryService()
    {
        ...
        static::assertInstanceOf('Scribe\MantleBundle\Component\HttpFoundation\Response\ResponseInterface', $response);
    ...
    public function testRequestFactoryServiceForJson()
    {
        ...
        static::assertInstanceOf('Scribe\MantleBundle\Component\HttpFoundation\Response\JsonResponse', $response);
        static::assertTrue($response->isOk());
    ...
    public function testRequestFactoryServiceForYaml()
    {
        ...
        $response->setData(['some' => 'array']);
        static::assertInstanceOf('Scribe\MantleBundle\Component\HttpFoundation\Response\YamlResponse', $response);
        static::assertTrue($response->isOk());
