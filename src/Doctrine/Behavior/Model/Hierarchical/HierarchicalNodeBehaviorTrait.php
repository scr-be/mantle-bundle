...
namespace Scribe\MantleBundle\Doctrine\Behavior\Model\Hierarchical;
...
trait HierarchicalNodeBehaviorTrait
{
     ...
     * {@inheritdoc}
     **/
    public function isIndirectChildNodeOf(HierarchicalNodeInterface $node)
    {
     ...
     * {@inheritdoc}
     **/
    public function setParentNode(HierarchicalNodeInterface $node)
    {
        $this->parentNode = $node;
