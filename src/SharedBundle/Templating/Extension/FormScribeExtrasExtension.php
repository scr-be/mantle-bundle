...
class FormScribeExtrasExtension extends Twig_Extension
{
    ...
    public function formSubmitNoWrap($form, $title, $defaultRoute = null, $btnClasses = [])
    {
        return $this->getEngine()->render(
            'ScribeSharedBundle:Form:submit-no-wrapper.html.twig',
            [
                'form'               => $form,
                'title'              => $title,
    ...
    {
        return $this->getEngine()->render(
            'ScribeSharedBundle:Form:submit.html.twig',
            [
                'form'               => $form,
                'title'              => $title,
                'cancel'             => $this->getReferer($defaultRoute),
    ...
    public function formLabel($form, $label = null, $classes = [])
    {
        ...
        return $this->getEngine()->render(
            'ScribeSharedBundle:Form:label.html.twig',
            [
                'form'  => $form,
                'label' => $label,
                'classes' => $classesStr,
    ...
    {
        return $this->getEngine()->render(
            'ScribeSharedBundle:Form:widget.html.twig',
            [
                'form'        => $form,
    ...
    {
        return $this->getEngine()->render(
            'ScribeSharedBundle:Form:error.html.twig',
            [
                'form' => $form,
            ]
        );
    ...
    {
        return $this->getEngine()->render(
            'ScribeSharedBundle:Form:item.html.twig',
            [
    ...
    {
        return $this->getEngine()->render(
            'ScribeSharedBundle:Form:itemHorizontal.html.twig',
            [
    ...
    {
        return $this->getEngine()->render(
            'ScribeSharedBundle:Form:itemNoGroup.html.twig',
            [
                'label'  => null,
                'widget' => $this->formWidget($form, $placeholder, $attributes),
                'error'  => $this->formError($form),
    ...
    public function formStart($form, $classes = [], $attr = [])
    {
        ...
        return $this->getEngine()->render(
            'ScribeSharedBundle:Form:start.html.twig',
            [
                'form' => $form,
                'attr' => $attr,
            ]
    ...
    {
        return $this->getEngine()->render(
            'ScribeSharedBundle:Form:end.html.twig',
            [
                'form' => $form
            ]
        );
    ...
    public function formSubmitOld($title, $defaultRoute = null)
    {
        ...
        return $engine->render(
            'ScribeSharedBundle:Form:submit-old.html.twig',
            [
                'title'  => $title,
                'cancel' => $referer,
            ]
