...
namespace Scribe\MantleBundle\Component\HttpFoundation\Exception;

use Symfony\Component\HttpKernel\Exception\UnauthorizedHttpException as SymfonyUnauthorizedHttpException;
use Scribe\MantleBundle\Component\HttpFoundation\Exception\Model\HttpExceptionInterface;
use Scribe\MantleBundle\Component\HttpFoundation\Exception\Model\HttpExceptionTrait;
use Scribe\Wonka\Exception\ExceptionTrait;

/**
 * Class UnauthorizedHttpException.
 */
class UnauthorizedHttpException extends SymfonyUnauthorizedHttpException implements HttpExceptionInterface
{
    use ExceptionTrait;
    ...
    {
        return self::CODE_HTTP_UNAUTHORIZED;
    }
}
